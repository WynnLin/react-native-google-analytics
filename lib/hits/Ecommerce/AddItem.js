...
export default class AddItem extends Hit {
    constructor(action, {id, name, brand, category, position, price, quantity, variant}) {
        super({
            id: id,
            name: name,
            brand: brand,
    ...
    add(enhancedEcommerce) {
        // AddItem property 'id' or 'name' is a required field.
        ...
        impression[`pr${productIndex}qt`] = this.properties.quantity
